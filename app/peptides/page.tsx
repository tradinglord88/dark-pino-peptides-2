      ...
      <div className="relative min-h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 flex items-center justify-center min-h-[500px]">
          <div className="text-center text-white max-w-2xl">
            ...
            <Link
              href="/products"
              className="inline-block px-8 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-bold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Shop All Peptides
            </Link>
          </div>
